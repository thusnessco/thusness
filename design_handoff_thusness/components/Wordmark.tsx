...
//
// Usage:
//   <Wordmark />                         // default, 20px, "~ as it is"
//   <Wordmark size={32} />               // scale up for hero use
//   <Wordmark tagline="thusness.co" />   // web-header variant
//   <Wordmark tagline={null} />          // wordmark only, no tagline/rule
//
// Ports cleanly to CSS Modules or styled-components — swap inline styles
// for class names as needed.
