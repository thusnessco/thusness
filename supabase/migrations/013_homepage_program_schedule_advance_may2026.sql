...
set content_json = replace(
  ...
  replace(
    content_json::text,
    'week 2 of 4', 'week 3 of 4'),
    'Wed · May 13', '__THUSNESS_MIG_D1__'),
    'Fri · May 15', '__THUSNESS_MIG_D2__'),
    'Wed · May 06', 'Wed · May 13'),
    'Fri · May 08', 'Fri · May 15'),
    '__THUSNESS_MIG_D1__', 'Wed · May 20'),
    '__THUSNESS_MIG_D2__', 'Fri · May 22'),
    'Week 3', 'Week 4'),
    'Week 2', 'Week 3')
)::jsonb
